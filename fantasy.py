...
class Application(Frame):
    ...
    def __init__(self, master):
        ...
        self.numberList = ['1'] + [str(n+1) for n in range(39)]
        ...
        self.numberList.config(width=3)
        ...
        self.numOption.grid(row=0, column=0, padx=(150,5), pady=5, sticky="W")
        self.numberList.grid(row=0, column=0, padx=(220,5), pady=5, sticky="W")
