...
class Application(Frame):
    ...
    def __init__(self, master):
        ...
        self.dataCheck = LabelFrame(self.dataTab, text=' Filter Numbers', style="O.TLabelframe")
    ...
    def showSelect(self):
        ...
        self.dSel = dn.displaySelection(self.allNumbers, self.intvars, 3)
    ...
    def getSelections(self):
        ...
        all_numbers = self.dataconn.get_top_stats_by_date(curr_date, 'mega_lotto')
        ...
        if self.baseOption.get() == 3:
            if self.foundSelected:
                ...
                messagebox.showinfo(parent=self.selectNumbers, title='No Selection', message='No selections made for Mega Lotto')
    ...
    def recomThread(self):
        ...
        if self.recommended:
            ...
            messagebox.showinfo(parent=self.selectNumbers, title='No recommendations', message='No recommendations made for Mega Lotto')
    ...
    def getSelectedNumbers(self):
        ...
        select_sql = f'''
        select selected from selected_numbers where table_name = 'mega_lotto'
        '''
    ...
    def setSelection(self):
        ...
        if self.foundSelected:
            ...
            select_data = ('mega_lotto', selected)
    ...
    def exportToCSV(self):
        ...
        outfile = filepath + '/' + 'mega_lotto_' + datetime.now().strftime("%Y-%m-%d") + '.csv'
